...
export default function HowItWorksSection() {
  return (
    <section className="relative overflow-hidden bg-gray-50 isolate">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            style={{
              clipPath: `polygon(74.1% 44.1%, 100% 61.6%, 99.5% 26.9%, 85.25% 0.1%,
         ...
         bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500
          opacity-20 sm:left-[calc(40%-38rem)] sm:w-[40.1875rem]"
          />
        </div>
...
function StepItem({ icon, label, description }: Step) {
  ...
  border border-white/10 hover:border-rose-500/50 transition-colors group w-full"
    >
