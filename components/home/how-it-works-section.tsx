...
export default function HowItWorksSection() {
  return (
    <section className="relative overflow-hidden bg-fuchsia-50">
      ...
      >
        <div
          style={{
            clipPath:
              "polygon(" +
              "74.1% 44.1%, 100% 61.6%, 99.5% 26.9%, " +
              "85.25% 0.1%, 88.7% 2%, 72.5% 32.5%, " +
          ...
          opacity-20 sm:left-[calc(48%-38rem)] sm:w-[40.1875rem]"
        />
      </div>
